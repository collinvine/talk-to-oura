...
import type { OuraSleepData, OuraActivityData, OuraReadinessData, OuraHeartRateData } from "@shared/schema";
        ...
        <Card>
          ...
          <CardContent>
            <div className="h-[200px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={heartRate.slice(-50)}>
                  <CartesianGrid strokeDasharray="3 3" className="stroke-muted" />
                  <XAxis 
                    dataKey="timestamp" 
